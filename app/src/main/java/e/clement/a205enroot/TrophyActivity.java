...
public class TrophyActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void launchActivity(int tab){
        Intent myIntent = new Intent(TrophyActivity.this,MainActivity.class);;
        switch (tab){

            case 0:
                myIntent = new Intent(TrophyActivity.this,MainActivity.class);
                break;
            case 1:
                myIntent = new Intent(TrophyActivity.this,TrophyActivity.class);
                break;
            case 2:
                myIntent = new Intent(TrophyActivity.this,SponsorsActivity.class);
                break;
            case 3:
                break;
            case 4:
